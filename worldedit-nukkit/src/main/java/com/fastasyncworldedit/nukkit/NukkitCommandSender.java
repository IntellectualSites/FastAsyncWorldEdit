...
public class NukkitCommandSender extends AbstractNonPlayerActor {
    ...
    public void print(Component component) {
        // Apply locale-aware translation/formatting before serializing to plain text, otherwise
        // translatable keys (Caption.of(...)) are printed verbatim to the console.
        sender.sendMessage(PlainComponentSerializer.INSTANCE.serialize(
