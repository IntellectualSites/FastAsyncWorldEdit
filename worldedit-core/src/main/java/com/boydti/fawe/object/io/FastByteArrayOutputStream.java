...
public class FastByteArrayOutputStream extends OutputStream {
    ...
    public FastByteArrayOutputStream(int initialBlockSize) {
        Preconditions.checkArgument(initialBlockSize > 0, "Initial block size must be greater than 0");
    ...
    public void resize(int targetCapacity) {
        Preconditions.checkArgument(targetCapacity >= size(), "New capacity must not be smaller than current size");
     ...
     */
    public static final class FastByteArrayInputStream extends InputStream {
