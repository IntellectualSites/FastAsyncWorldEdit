...
import com.fastasyncworldedit.nukkitmot.FaweNukkit;
...
/**
 * FastAsyncWorldEdit plugin entry point for Nukkit-MOT.
 */
public class WorldEditNukkitPlugin extends PluginBase {
    ...
    public void onEnable() {
        ...
        getLogger().info("FastAsyncWorldEdit for Nukkit-MOT enabled.");
    }
    ...
    public void onDisable() {
        ...
        getLogger().info("FastAsyncWorldEdit for Nukkit-MOT disabled.");
    }
