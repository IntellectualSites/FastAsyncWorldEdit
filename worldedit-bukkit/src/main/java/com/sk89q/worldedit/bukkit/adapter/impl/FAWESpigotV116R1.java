...
import com.boydti.fawe.bukkit.adapter.mc1161.BlockMaterial1161;
...
import com.boydti.fawe.bukkit.adapter.mc1161.FAWEWorldNativeAccess1161;
import com.boydti.fawe.bukkit.adapter.mc1161.MapChunkUtil1161;
...
public final class FAWESpigotV116R1 extends CachedBukkitAdapter implements IDelegateBukkitImplAdapter<NBTBase> {
    ...
    public boolean setBlock(org.bukkit.Chunk chunk, int x, int y, int z, BlockStateHolder state, boolean update) {
        ...
        IBlockData existing;
        if (section == null) {
            existing = ((BlockMaterial1161) BlockTypes.AIR.getDefaultState().getMaterial()).getState();
        } else {
    ...
    public WorldNativeAccess<?, ?, ?> createWorldNativeAccess(org.bukkit.World world) {
        return new FAWEWorldNativeAccess1161(this,
    ...
    public void sendFakeChunk(org.bukkit.World world, Player player, ChunkPacket packet) {
        ...
        PlayerChunk map = BukkitAdapter1161.getPlayerChunk(nmsWorld, packet.getChunkX(), packet.getChunkZ());
