...
import com.sk89q.worldedit.bukkit.adapter.impl.fawe.v26_3.PaperweightGetBlocks;
...
public class PaperweightBlockMaterial extends BukkitBlockMaterial<Block, BlockState> {
    ...
    public float getHardness() {
        return this.blockState.getDestroySpeed(EmptyBlockGetter.INSTANCE, BlockPos.ZERO);
    }
    ...
    public boolean isFragileWhenPushed() {
        return this.blockState.getPistonPushReaction() == PushReaction.POPPED;
    }

    @Override
    public boolean isUnpushable() {
        return this.blockState.getPistonPushReaction() == PushReaction.IMMOVEABLE;
    }
