package com.sk89q.worldedit.bukkit.adapter.impl.fawe.v26_3;
...
public class LinValueInput implements ValueInput {
    ...
    private record ValueInputContext(HolderLookup.Provider lookup, DynamicOps<LinTag<?>> ops, ValueInput empty,
                                     ValueInputList emptyChildList, TypedInputList<?> emptyTypedList) {
    ...
    private static final class EmptyValueInputList implements ValueInputList {
    ...
    private static final class EmptyTypedInputList implements TypedInputList<Object> {
